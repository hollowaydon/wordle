# for each guess, answer pair:
#     compute score

# sum over answers in current wordset to get distribution over scores

# compute H(x) for that distribution of scores

# pick guess that maximises entropy.
#######################################
